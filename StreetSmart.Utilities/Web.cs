...
//using StreetSmart.Utilities.Layers;
//using StreetSmart.Utilities.Model;
//using StreetSmart.Utilities.Utilities;
    ...
    private Web()
    {
      ...
      ServicePointManager.DefaultConnectionLimit = DefaultConnectionLimit;
        ...
        public Stream DownloadSpatialReferences()
        {
            ...
            string url = string.Concat(Urls.ApiUrl, Urls.SpatialReferencesUrl);
