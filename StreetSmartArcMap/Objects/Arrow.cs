...
namespace StreetSmartArcMap.Objects
{
    class Arrow : IDisposable
    {
        ...
        // Constructor
        // =========================================================================
        private Arrow(ICoordinate location, IOrientation orientation, Color color)
        {
            _angle = orientation.Pitch ?? 0;
            _hFov = orientation.HFov ?? 0;
            _color = color;
            _blinking = false;
            _toUpdateArrow = false;
            _active = true;
            
            double x = location.X ?? 0;
            double y = location.Y ?? 0;
        ...
        // Functions (Static)
        // =========================================================================
        public static Arrow Create(ICoordinate location, IOrientation orientation, Color color)
        {
            return new Arrow(location, orientation, color);
        }
