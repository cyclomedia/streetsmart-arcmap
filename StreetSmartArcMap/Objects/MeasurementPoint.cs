...
namespace StreetSmartArcMap.Objects
{
    class MeasurementPoint : IDisposable
    {
        ...
        public double Z => (_point == null) ? 0.0 : (_point.Z);
        public IPoint Point => _point;
        public bool NotCreated => _point == null;
        public bool IsFirstNumber => _intId == 1;
        public bool IsLastNumber => (_measurement == null) || (_intId == _measurement.Count);
        public MeasurementPoint PreviousPoint => ((_measurement != null) && (!IsFirstNumber)) ? _measurement.GetPointByNr(_intId - 2) : null;
        public MeasurementPoint NextPoint => ((_measurement != null) && (!IsLastNumber)) ? _measurement.GetPointByNr(_intId) : null;
        ...
        {
            IPoint point = ArcUtils.ToMapPoint(x, y, z);
        ...
        public void UpdatePoint(IFeature measurementPoint, int index)
        {
            _index = index;
            ...
            _point = ArcUtils.ToMapPoint(x, y, z);
